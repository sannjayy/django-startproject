...
def global_context(request):
    ...
    keys = [
        "DEBUG_VALUE", "ENV_NAME", "ENABLE_LOGGER", "COMPANY_NAME", "PROJECT_TITLE", "PROJECT_SHORT_TITLE",
        "SUPPORT_EMAIL", "SECRET_KEY", "ALLOWED_HOSTS", "CORS_ALLOWED_ORIGINS", "PUBLIC_DOMAIN",
        "CURRENT_VERSION", "ADMIN_EMAIL", "TIME_ZONE", "LANGUAGE_CODE", "ENABLE_TEST_PANEL", "ENABLE_DRF",
        "ENABLE_SWAGGER", "USE_ASGI_MODE", "ENABLE_CRON_JOBS", "ENABLE_CELERY", "ENABLE_SMTP", "EMAIL_HOST",
        ...
        "DB_HOST", "DB_NAME", "DB_USER", "DB_PASSWORD", "DB_TYPE", "ENABLE_MONGO_ENGINE", "MONGO_DB_NAME",
        "MONGO_HOST_URI", "MONGO_USERNAME", "MONGO_PASSWORD", "ENABLE_REDIS", "REDIS_HOST", "REDIS_PORT",
